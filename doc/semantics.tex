...
\end{align*}
\begin{align*}
  %TODO remove Maybe\ Time
  calculus :: Real\ a\Rightarrow& (a \rightarrow a \rightarrow Time \rightarrow Time \rightarrow Maybe\ Time \rightarrow a \rightarrow a)\\
  \rightarrow& Maybe\ Time \rightarrow Behavior\ a\rightarrow Behavior\ Maybe\ a
\end{align*}
\begin{align*}
